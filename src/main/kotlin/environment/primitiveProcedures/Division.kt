...
class Division(): PrimitiveProcedure {
    ...
    override fun evaluate(expression: List<String>, environment: Environment): Pair<List<String>, Environment> {
        ...
        if(expression[0] != name) throw Exception("Bad procedure name given to division evaluator")
        ...
        return Pair(when {
            ...
            else -> throw Exception("Unexpected error while evaluating division procedure")
        }, environment)
    }
}