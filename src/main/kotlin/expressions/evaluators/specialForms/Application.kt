...
import expressions.evaluators.specialForms.predicates.VariablePredicate
...
class Application(
    ...
    private fun applyLambda(
        lambdaBody: List<String>,
        lambdaEnvironment: Environment,
        givenParameters: List<String>
    ): Pair<List<String>, Environment> {
